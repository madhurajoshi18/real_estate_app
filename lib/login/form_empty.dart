...
class FormEmpty extends StatefulWidget {
  @override
  State<FormEmpty> createState() => _FormEmptyState();
}

class _FormEmptyState extends State<FormEmpty> {
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              height: 70,
                              padding:
                                  const EdgeInsets.only(top: 22, bottom: 23),
                              decoration: BoxDecoration(
